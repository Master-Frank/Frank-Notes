...
点击`Recent Deliveries`可以看到执行WebHook的记录，点击蓝色小方框可以查看日志。

![image-20211105215945574](https://cdn.jsdelivr.net/gh/Master-Frank/Image-hosting/img/20211107092001.png)

在宝塔WebHook的日志中可以看到，已经执行成功了。

![image-20211107092317808](https://cdn.jsdelivr.net/gh/Master-Frank/Image-hosting/img/20211107092317.png)

## 6. 在Gitte中配置WebHook

我在使用**Github**的WebHook的过程中发现，git clone的**失败率非常高**，会导致网页无法访问403。为了解决这个问题，我尝试**[通过Github Actions把代码自动同步到Gitte](../432630/)**，然后让服务器从Gitte中拉取网页文件。
...
![image-20211107091546969](https://cdn.jsdelivr.net/gh/Master-Frank/Image-hosting/img/20211107092033.png)
